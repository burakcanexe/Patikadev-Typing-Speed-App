...
const wordsSlice = createSlice({
    ...
    reducers:{
        changeActiveWords:(state,action)=>{
...
export const { typingWord, changeActiveWords, timerR, setTyping, setWrong, setTrue } = wordsSlice.actions
